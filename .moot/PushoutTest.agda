...
{-
I was trying to show here that
T ⇒ — preserves pushouts
implies
T ⇒ — preserves dependent pushouts
but I no longer think the premise is true in the model, so fuggedaboudit
-}

module moot.PushoutTest {ℓ : Level} (T : Set ℓ) where
